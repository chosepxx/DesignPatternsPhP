...
class registro_pinturaServices extends db
{
    ...
    function agregarRegistroObserver($cod_registro, $administrador_observador)
    {

        $query = "INSERT INTO registroObservador SET
             cod_registro =:cod_registro, administrador_observador =:administrador_observador";
